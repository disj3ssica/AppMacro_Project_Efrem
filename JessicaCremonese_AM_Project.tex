...
During the course, we have examined time series and IRFs for a similar VAR model based on the monetary policy proxy MPI\_FF4. Therefore, I will not present my IRFs output for the case of a MP shock and will instead refer to the provided material for any comparisons.
...
%prices
Initially, only the policy rate and the unemployment rate respond significantly to the shock. Employment increases and so does the policy rate, in line with the positive expectations of the CB for the future economic conditions. Prices show a postive and persistent effect as the economy heats up. Following the rest of the variables, corporate spreads drop in response to positive news about economic fundamentals. 
% GFC
 ...
 %ADDITIONAL
  \begin{figure}[ht]
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[scale=.3]{Graphs/forecast_err_variance_decomp.jpg}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[scale=.3]{Graphs/historical_decomp_nolegend.jpg}
