...
% comment HD of the info shock (very noisy, is it to be expected?) and of the GFC (nei periodi di crisi l'info shock è più o meno capace di spiegare le fluttuazioni di GFC?)
