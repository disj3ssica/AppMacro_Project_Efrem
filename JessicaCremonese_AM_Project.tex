 ...
 % - - - - - - - - - FIGURE 2 - - - - - - - - -
    \begin{figure}[hp]
        ...
        \begin{subfigure}{\textwidth}
            \centering
            \includegraphics[scale=.32]{Graphs/forecast_err_variance_decomp_6lags.jpg}
        ...
        \begin{subfigure}{\textwidth}
            \centering
            \includegraphics[scale=.32]{Graphs/INFO_FF4_HD_6lags.jpg}
        ...
        \begin{subfigure}{\textwidth}
            \centering
            \includegraphics[scale=.32]{Graphs/GFC_HD_6lags.jpg}
            \includegraphics*[scale=0.22]{Graphs/Inkedlegend.jpg}
            \captionsetup{font=scriptsize}
