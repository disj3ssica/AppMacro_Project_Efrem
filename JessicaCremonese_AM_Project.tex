...
To estimate the effects of an information shock on the GFC, I employ a VAR model with six lags, a constant, and a trend. The ordering of the variables in the model follows the rationale of Christiano, Eichenbaum and Evans (2005). The model is estimated using Ambrogio Cesa-Bianchi's VAR Toolbox for MatLab.
...
%IRFs   - - - - - - - FIGURE 1 - - - - - - - - 
    \begin{figure}
        \centering
        \includegraphics[scale=.39]{Graphs/IRF68_6lags.jpg}
 ...
 % - - - - - - - - - FIGURE 2 - - - - - - - - -
    \begin{figure}[hp]
        ...
        \begin{subfigure}{\textwidth}
            \centering
            \includegraphics[scale=.31]{Graphs/forecast_err_variance_decomp_6lags.jpg}
        ...
        \begin{subfigure}{\textwidth}
            \centering
            \includegraphics[scale=.31]{Graphs/INFO_FF4_HD_6lags.jpg}
            \includegraphics*[scale=0.21]{Graphs/Inkedlegend.jpg}
            \captionsetup{font=scriptsize}
        ...
        \begin{subfigure}{\textwidth}
            \centering
            \includegraphics[scale=.31]{Graphs/GFC_HD_6lags.jpg}
            \includegraphics*[scale=0.21]{Graphs/Inkedlegend.jpg}
            \captionsetup{font=scriptsize}
