...
To estimate the effects of an information shock on the GFC, I employ a VAR model with three lags, a constant, and a trend. The ordering of the variables in the model follows Christiano, Eichenbaum and Evans (2005). The model is estimated using Ambrogio Cesa-Bianchi's VAR Toolbox for MatLab.

The dataset consists of monthly observations from 1991 to 2015. I include all available variables in the model, namely the unemployment rate, a logarithmic transformation of the Consumer Price Index (CPI), the 3-month policy rate, and the GFC 10-year-3-month spread.
...
Initially, only the policy rate and the unemployment rate respond significantly to the shock. Employment increases and so does the policy rate, in line with the positive expectations of the CB for the future economic conditions. Prices show a postive and persistent effect as the economy heats up. Following the expansionary trend of the other variables, corporate spreads drop in response to positive news about economic fundamentals. 
% GFC description
The GFC shows a positive and significant response for a few periods after the shock hits the economy, in line with what was previously discussed. Agents expect the US fundamentals to be good, therefore the spillover mechanisms boost the GFC as discussed in Section 1.
...
% comment GFC response to POLICY RATE and to INFO SHOCK
% comment SPREAD response to poliy rate and to info shock
